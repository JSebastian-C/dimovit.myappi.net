            	...
            	<a href="<?php the_permalink() ?>" title="<?php the_title_attribute() ?>">
                	<?php if($icon){
						if($icon_id = leafcolor_get_attachment_id_from_url($icon)){
							$thumbnail = wp_get_attachment_image_src($icon_id,'applay_thumb_263x263', true);
					...
					<?php $icon = 0;
						...
						the_post_thumbnail(get_the_ID(),'applay_thumb_263x263');
					}?>
                </a>
            </div>
