...
if ( $product->is_in_stock() ) : ?>
	...
	<form class="cart" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data'>
		...
		?>
        	<a class="single_add_to_cart_button btn btn-primary btn-lg btn-block" href="<?php echo esc_url($link_dl);?>" <?php if($link_dl != '#top'){?>  target="_blank" <?php }?>><i class="fa fa-download"></i> <?php esc_html_e('Download now','applay'); ?></a>
        <?php } ?>
