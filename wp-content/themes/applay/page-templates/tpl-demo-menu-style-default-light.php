...
<?php
	//prepare page title
	global $page_title;
	$page_title = esc_html__('Demo menu style Light','applay');
?>
<div id="body-wrap">
    <div id="wrap">
        <header>
			...
			$nav_des = 'on';
			?>
			<div id="main-nav" class=" light-nav <?php if($nav_des=='off'){?> disable-description <?php }?>" <?php if(leaf_get_option('nav_sticky','on')=='on'){?>data-spy="affix" data-offset-top="280"<?php } ?>>
                <nav class="navbar navbar-inverse <?php if($nav_style){?> style-off-canvas <?php } ?>" role="navigation">
                    <div class="container">
                        <!-- Brand and toggle get grouped for better mobile display -->
                        <div class="navbar-header">
                            
                            <a class="logo" href="<?php echo esc_url( home_url('/') ); ?>"><img src="<?php echo esc_url(get_template_directory_uri()) ?>/images/web-logo-light.png" alt="<?php esc_attr_e('Logo','applay'); ?>"></a>
...
?>
    ...
    <div id="body">
        ...
        <?php }?>
            ...
            <?php }?>
                <div class="row">
                    <div id="content" class="<?php echo esc_attr(($layout != 'full' && $layout != 'true-full')?'col-md-9':'col-md-12'); ?><?php if($layout == 'left'){?> revert-layout <?php }?>" role="main">
