                ...
                <nav class="navbar navbar-inverse <?php  if($nav_style){ ?> style-off-canvas <?php }?>" role="navigation">
                    <div class="container">
                        ...
                        <div class="navbar-header">
                            ...
                            <a class="logo" href="<?php echo esc_url( home_url('/') ); ?>"><img src="<?php echo get_template_directory_uri() ?>/images/web-logo.png" alt="<?php esc_attr_e('Logo','applay'); ?>"></a>
                            <?php else:?>
                            ...
                            <a class="logo sticky" href="<?php echo esc_url( home_url('/') ); ?>" title="<?php wp_title( '|', true, 'right' ); ?>"><img src="<?php echo esc_url(leaf_get_option('sticky_logo_image')); ?>" alt="<?php wp_title( '|', true, 'right' ); ?>"/></a>
                            <?php endif;?>
                        </div>
