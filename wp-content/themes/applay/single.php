...
$layout = $single_page_layout ? $single_page_layout : ($global_page_layout ? $global_page_layout : leaf_get_option('post_layout','right'));
                    ...
                    <div id="content" class="<?php if($layout!='full'){ ?> col-md-9 <?php }else{ ?> col-md-12 <?php } if($layout == 'left'){ ?> revert-layout <?php }?>" role="main">
                        <article class="single-post-content single-content">
							...
							while ( have_posts() ) : the_post();
								...
								echo '<h2 class="blog-title title entry-title">'.get_the_title().'</h2>';
								get_template_part('templates/single/content','single');
							endwhile;
							?>
                        </article>
                        <?php if(leaf_get_option('enable_author')!='off' && get_the_author_meta('description')){ ?>
                        ...
                        <?php }?>
                        <?php if(leaf_get_option('single_navi')!='off'){ ?>
                            ...
                            <div class="row">
                                ...
                                <?php
                                    ...
                                    <div class="single-post-navigation-item-content">
                                        <h4 class="font-2"><i class="fa fa-angle-left"></i> &nbsp;' . esc_html($p->post_title) . '</h4>
                                    </div>
									</a>';}
                                ?>
                                </div>
                                ...
                                <?php
									...
									<div class="single-post-navigation-item-content">
										<h4 class="font-2">' . esc_html($n->post_title) . '&nbsp; <i class="fa fa-angle-right"></i></h4>
									</div>
									</a>';  
								?>
                                </div>
