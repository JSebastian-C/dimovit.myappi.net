            ...
            <div id="content" class="<?php echo $port_sidebar!='full'?'col-md-9':'col-md-12' ?><?php echo ($port_sidebar == 'left') ? " revert-layout":"";?>">
                        <article class="single-post-content portfolio single-content">
							...
							if($devide!='def_themeoption' && $devide!='def' && $devide!='' ){
                                                        ...
                                                        <div class="hidden">
                                                            <div class="popup-data dark-div">
                                                                ...
                                                                <div class="popup-data-content">
                                                                    ...
                                                                    <a href="<?php echo get_permalink($attachment_id); ?>#comment" class="btn btn-default popup-gallery-comment" title="<?php _e('View comments','applay'); ?>"><?php _e('COMMENTS','applay'); ?></a>
                                ...
                                <a class="single_add_to_cart_button btn btn-primary btn-lg btn-block" href="#top"><i class="fa fa-download"></i> <?php _e('Download now','applay'); ?></a>
                                </div><!--end info-->
                                <?php } ?>
                                ...
                                <?php
                                $pagiarg = array(
                                    'before'           => '<div class="single-post-pagi">'.__( 'Pages:','applay'),
                                    'after'            => '</div>',
                                    'link_before'      => '<span type="button" class="btn btn-default btn-sm">',
                                    'link_after'       => '</span>',
                                    'next_or_number'   => 'number',
                                    'separator'        => ' ',
                                    'nextpagelink'     => __( 'Next page','applay'),
                                    'previouspagelink' => __( 'Previous page','applay'),
                                    'pagelink'         => '%',
                                    'echo'             => 1
                                );
                                ...
                                <div class="item-meta single-post-meta content-pad">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <?php _e('Comment','applay') ?>
                                            <div class="media-heading"><a href="#comment"><?php comments_number(__('0 Comments','applay'),__('1 Comment','applay')); ?></a></div>
                                        </div>
                                    </div>
