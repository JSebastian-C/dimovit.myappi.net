<?php
function print_ia_countdown($atts, $content){
	...
	ob_start(); ?>
    <div class="ia_countdown ia_countdown-<?php echo $ID; echo ' '.@$animation_class; ?>" data-countdown="<?php echo $year.'/'.$month.'/'.$day.' '.$hour.':'.$minute.':00' ?>" data-daylabel='<?php _e('Days','applay') ?>' data-hourlabel='<?php _e('Hrs','applay') ?>' data-minutelabel='<?php _e('Mins','applay') ?>' data-secondlabel='<?php _e('Secs','applay') ?>' data-showsecond='<?php echo $show_second ?>' data-delay=<?php echo $animation_delay; ?>></div>
...
add_shortcode( 'ia_countdown', 'print_ia_countdown' );
	...
	vc_map( array(
	   ...
	   "params" => array(
		  ...
		  array(
			 ...
			 "holder" => "div",
			 "class" => "",
			 "heading" => __("Background Color", 'applay'),
			 "param_name" => "bg_color",
			 "value" => '',
			 "description" => ''
		  ),
		  array(
			 ...
			 "holder" => "div",
			 "class" => "",
			 "heading" => __("Number Color", 'applay'),
