<?php
function print_ia_iconbox($atts, $content=''){
...
add_shortcode( 'ia_iconbox', 'print_ia_iconbox' );
...
function reg_ia_iconbox(){
	...
	vc_map( array(
	   ...
	   "params" => array(
		  ...
		  array(
			"type" => "textarea",
			"heading" => __("Content text", "applay"),
			"param_name" => "content",
			"value" => "",
		  ...
		  array(
			 ...
			 "holder" => "div",
			 "class" => "",
			 "heading" => __("Icon Background Hover", 'applay'),
