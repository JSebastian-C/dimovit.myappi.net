...
function reg_leaf_pricingtable(){
	...
	vc_map( array(
			"name" => esc_html__("Pricing Table", "applay"),
			"base" => "c_column",
			...
			"params" => array(
				array(
					"type" => "textfield",
					"heading" => esc_html__("Column Title", "applay"),
					"param_name" => "title",
					"value" => "Table Column",
					"description" => "",
					"admin_label" => true
				...
				array(
					"type" => "textfield",
					"heading" => esc_html__("CSS Class", "applay"),
					"param_name" => "class",
					"value" => "",
					"description" => "",
				  ),
				  array(
					 ...
					 "holder" => "div",
					 "class" => "",
					 "heading" => esc_html__("Background Color", 'applay'),
					 "param_name" => "bg_color",
					 "value" => '',
					 "description" => '',
				  ),
				  array(
					"type" => "textfield",
					"heading" => esc_html__("Price", "applay"),
					"param_name" => "price",
					"value" => "10$",
					"description" => "",
					"admin_label" => true
				   ...
				   array(
					"type" => "textfield",
					"heading" => esc_html__("Price Text", "applay"),
				   ...
				   array(
					 ...
					 "holder" => "div",
					 "class" => "",
					 "heading" => esc_html__("Color", 'applay'),
					 "param_name" => "color",
					 "value" => '',
					 "description" => '',
				  ),
		...
		vc_map( array(
			...
			"params" => array(
				array(
					"type" => "textarea_html",
					"heading" => esc_html__("Row Content", "applay"),
					"param_name" => "content",
					"value" => "Content",
					"description" => "",
					"admin_label" => true
